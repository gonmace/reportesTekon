...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('registrostxtss', '0005_remove_registrostxtss_unique_user_with_registro0_true_and_more'),
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='registrostxtss',
            constraint=models.UniqueConstraint(fields=('sitio',), name='unique_sitio_with_registro0_true'),
        ),
    ]
