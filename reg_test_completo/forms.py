"""
Formularios para registros reg_test_completo.
"""
...
class Paso1Form(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['registro'].queryset = RegTestCompleto.objects.all()
        
        try:
            if self.registro_id:
                registro_obj = RegTestCompleto.objects.get(id=self.registro_id)
                ...
                self.fields['registro'].widget = forms.HiddenInput()
        except RegTestCompleto.DoesNotExist:
            self.fields['registro'].widget = forms.HiddenInput()
