"""
Vistas para registros Test Completo.
"""
...
class ListRegistrosView(GenericRegistroTableListView):
    """Vista para listar registros Test Completo usando tabla genérica."""
    ...
    def get_breadcrumbs(self):
        ...
        return [
            ...
            {'label': 'Test Completo'}  # Página actual sin URL
        ]


class StepsRegistroView(GenericRegistroStepsView):
    """Vista para mostrar los pasos de un registro Test Completo."""
...
class ElementoRegistroView(GenericElementoView):
    """Vista para manejar elementos de registro Test Completo."""
...
class ActivarRegistroView(GenericActivarRegistroView):
    """Vista para activar registros Test Completo."""
