"""
Formularios para registros reg_mantenimiento.
"""
...
class InspeccionForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['registro'].queryset = RegMantenimiento.objects.all()
        
        try:
            if self.registro_id:
                registro_obj = RegMantenimiento.objects.get(id=self.registro_id)
                ...
                self.fields['registro'].widget = forms.HiddenInput()
        except RegMantenimiento.DoesNotExist:
            self.fields['registro'].widget = forms.HiddenInput()
