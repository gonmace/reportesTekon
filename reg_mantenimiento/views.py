"""
Vistas para registros Mantenimiento Preventivo.
"""
...
class ListRegistrosView(GenericRegistroTableListView):
    """Vista para listar registros Mantenimiento Preventivo usando tabla genérica."""
    ...
    def get_breadcrumbs(self):
        ...
        return [
            ...
            {'label': 'Mantenimiento Preventivo'}  # Página actual sin URL
        ]


class StepsRegistroView(GenericRegistroStepsView):
    """Vista para mostrar los pasos de un registro Mantenimiento Preventivo."""
...
class ElementoRegistroView(GenericElementoView):
    """Vista para manejar elementos de registro Mantenimiento Preventivo."""
...
class ActivarRegistroView(GenericActivarRegistroView):
    """Vista para activar registros Mantenimiento Preventivo."""
