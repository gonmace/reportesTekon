"""
Vistas para registros Instalación.
"""
...
class ListRegistrosView(GenericRegistroTableListView):
    """Vista para listar registros Instalación usando tabla genérica."""
    ...
    def get_breadcrumbs(self):
        ...
        return [
            ...
            {'label': 'Instalación'}  # Página actual sin URL
        ]


class StepsRegistroView(GenericRegistroStepsView):
    """Vista para mostrar los pasos de un registro Instalación."""
...
class ElementoRegistroView(GenericElementoView):
    """Vista para manejar elementos de registro Instalación."""
...
class ActivarRegistroView(GenericActivarRegistroView):
    """Vista para activar registros Instalación."""
