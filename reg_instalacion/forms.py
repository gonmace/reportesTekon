"""
Formularios para registros reg_instalacion.
"""
...
class SitioForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['registro'].queryset = RegInstalacion.objects.all()
        
        try:
            if self.registro_id:
                registro_obj = RegInstalacion.objects.get(id=self.registro_id)
                ...
                self.fields['registro'].widget = forms.HiddenInput()
        except RegInstalacion.DoesNotExist:
            self.fields['registro'].widget = forms.HiddenInput()
...
class EmpalmeForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        self.registro_id = kwargs.pop('registro_id', None)
        super().__init__(*args, **kwargs)
