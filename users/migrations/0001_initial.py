    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('ADMIN', 'Administrador'), ('ITO', 'Inspector Técnico de Obra'), ('CLIENT', 'Cliente')], default='ITO', max_length=50, verbose_name='Tipo de Usuario')),
